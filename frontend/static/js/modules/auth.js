...
const AuthModule = {
    ...
    permissions: {
        ...
        'COMERCIAL FRIMETALS': ['metals-dashboard', 'metals-pedidos', 'pedidos', 'almacen', 'comercial-historico', 'facturacion'],
        ...
        'JEFE AUXILIAR INVENTARIO': ['inventario', 'inyeccion', 'pulido', 'ensamble', 'empaque', 'exportacion-wo', 'pnc', 'historial', 'asistencia', 'compras'],
        ...
        'ENSAMBLE': ['inyeccion', 'ensamble', 'asistencia', 'compras'],
